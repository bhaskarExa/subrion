...
class iaBackendController extends iaAbstractControllerBackend
{
    ...
    public $page_cust_content;


    public function __construct()
    {
        parent::__construct();
        $this->page_cust_content = '<table align="center" style="color: red;" border="2"><tr><th>Test Head</th></tr><tr><td>Test Head</td></tr></table>';//exit;
        //echo htmlentities($this->page_cust_content);exit;
        //$this->page_cust_content = '1';//exit;
...
SQL;
    ...
    protected function _assignValues(&$iaView, array &$entryData)
    {
        ...
        //echo '<pre>';print_r($this->_loadMultilingualData($entryData['name']));exit;
        list($page_cust_content_mine, $title, $content, $metaDescription, $metaKeywords, $metaTitles) = $this->_loadMultilingualData($entryData['name']);
...
//echo $page_cust_content_mine;
        //echo $title;
//exit;

        //
        //$iaView->assign('page_cust_content_mine', htmlentities($page_cust_content_mine));
        $iaView->assign('page_cust_content_mine', $page_cust_content_mine);
        ////$iaView->assign('page_cust_content', $page_cust_content);
        //
    }
...
SQL;
    ...
    private function _loadMultilingualData($pageName)
    {
        ...
        return [$this->page_cust_content, $title, $content, $metaDescription, $metaKeywords, $metaTitles];
